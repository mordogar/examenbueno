# Definimos el almacén con los productos y sus detalles
productos_almacen = {
    "Estantería A": [
...
def buscar_producto(productos_almacen, nombre_producto):
    ...
    if resultado:
        print(f"Producto '{nombre_producto}' encontrado en las siguientes ubicaciones:")
        for r in resultado:
            print(f"- {r['estanteria']}: {r['cantidad']} unidades disponibles")
    else:
...
buscar_producto(productos_almacen, nombre_producto)
